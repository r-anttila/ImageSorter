...
parser.add_argument(
    '--in_folder', help="The path to the folder you want to sort. Default is current folder.", default=path.Path())
...
parser.add_argument('--cv_folder', help='The path to the folder containing the cv2 installation',
...
profileface_cascade = os.path.join(
    args.cv_folder, "data\haarcascade_profileface.xml")
frontalface_cascade = os.path.join(
    args.cv_folder, "data\haarcascade_frontalface_alt.xml")
